...
export const chart2Config: IOfficialPluginConfig = {
  id: 'plgchartV2',
  name: 'Chart V2',
  description: 'Visualize your records on a bar, line, pie, base on ECharts',
  detailDesc: `
  ...
  i18n: {
    zh: {
      ...
      description: '通过柱状图、折线图、饼图可视化您的记录, 基于 ECharts 实现',
      detailDesc:
        '如果您想通过色彩丰富的方式从大局上了解表格，试试图表应用。\n\n图表应用汇总表格记录，并将其转换为交互式的柱状图、折线图、饼图。\n\n[了解更多](https://teable.cn)',
    },
  },
  logoPath: 'static/plugin/chartV2.png',
};
