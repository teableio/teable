...
export class ReferenceService {
  ...
  async calculate(props: {
    ...
    // TODO: remove calculation (legacy path retained for reference)
    // Intentionally no-op. Lookup/rollup/link derived values are computed at query time.
  }
  ...
  collectChanges(
    ...
    // Note: do not short-circuit on field.hasError here; caller decides how to display errored fields
