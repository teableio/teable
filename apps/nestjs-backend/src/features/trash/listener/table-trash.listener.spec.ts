...
describe('TableTrashListener', () => {
  it('persists record delete snapshots through the data prisma transaction', async () => {
    ...
    const payload: IDeleteRecordsPayload = {
      ...
      records: [
        {
          id: 'recTrashListenerOne',
          fields: { fldText: 'A' },
          createdTime: '2026-07-01T00:00:00.000Z',
          createdBy: 'usrTrashListenerCreator',
          lastModifiedTime: '2026-07-02T00:00:00.000Z',
          lastModifiedBy: 'usrTrashListenerModifier',
        },
      ...
      data: [
        {
          ...
          createdTime: expect.any(Date),
          operationId: 'oprTrashListenerRecord',
          recordCreatedTime: new Date('2026-07-01T00:00:00.000Z'),
          recordCreatedBy: 'usrTrashListenerCreator',
          recordLastModifiedTime: new Date('2026-07-02T00:00:00.000Z'),
          recordLastModifiedBy: 'usrTrashListenerModifier',
        },
        {
          id: expect.any(String),
          tableId: 'tblTrashListenerTable',
          ...
          createdTime: expect.any(Date),
          operationId: 'oprTrashListenerRecord',
          recordCreatedTime: undefined,
          recordCreatedBy: undefined,
          recordLastModifiedTime: undefined,
          recordLastModifiedBy: undefined,
        },
      ],
    });
