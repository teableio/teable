...
export const DescContent = () => {
  ...
  return (
    <div className="shrink-1 relative hidden flex-1 basis-1/4 items-center justify-center border-e p-10 shadow-lg lg:flex">
      ...
      <div className="overflow-hidden">
        <h2 className="absolute -translate-y-full text-wrap pe-10 text-6xl font-bold">
