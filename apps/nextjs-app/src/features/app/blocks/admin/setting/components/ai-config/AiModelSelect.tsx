...
export function AIModelSelect({
  ...
  const renderGatewayOptions = (options: IModelOption[], showGroupHeading = false) => {
            ...
            <ScrollArea className="w-full">
              <div className="max-h-[500px]">
                <CommandList>
                  {needGroup ? (
                    <Fragment>
                      {renderGatewayOptions(gatewayOptions, true)}
                      {renderSpaceOptions(spaceOptions, !!gatewayOptions.length)}
