            ...
            {isLoadingModels ? (
              ...
              <CommandGroup>
                {filteredModels.map((model) => {
                  ...
                  const ModelIcon = model.owned_by
                    ? GATEWAY_PROVIDER_ICONS[model.owned_by as keyof typeof GATEWAY_PROVIDER_ICONS]
                    : undefined;
                  return (
                    <CommandItem
                      key={model.id}
                    ...
                    >
                      <div className="flex flex-1 items-center justify-between">
                        <div className="flex min-w-0 flex-1 flex-col gap-2">
                          ...
                          {model.name && (
                            <div className="pl-6 text-xs text-muted-foreground">{model.name}</div>
                          )}
                        </div>
                        <div className="flex items-center gap-2">
