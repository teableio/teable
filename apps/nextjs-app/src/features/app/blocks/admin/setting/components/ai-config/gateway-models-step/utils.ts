...
export function getPricingFromApiModel(
  ...
  if (apiModel.pricing.input_cache_read) pricing.inputCacheRead = apiModel.pricing.input_cache_read;
  if (apiModel.pricing.input_cache_write)
    pricing.inputCacheWrite = apiModel.pricing.input_cache_write;
  if (apiModel.pricing.web_search) pricing.webSearch = apiModel.pricing.web_search;
