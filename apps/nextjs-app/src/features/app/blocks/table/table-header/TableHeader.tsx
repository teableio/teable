...
import { AddView } from '@overridable/AddView';
...
const RightActions = ({ setIsEditing }: { setIsEditing?: (isEditing: boolean) => void }) => {
  ...
  // Handed to the menu in every layout: the phone's sheet and the tablet's dropdown alike.
  const onDescription = showDescription
    ? () => {
        setOpen(false);
