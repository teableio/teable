...
export const KanbanStackTitle = (props: IKanbanStackTitle) => {
  ...
  return (
    <>
      {isUncategorized ? (
        <div className="flex items-center space-x-2 overflow-hidden text-muted-foreground rtl:space-x-reverse">
        ...
        <div
          className="flex items-center space-x-2 overflow-hidden text-muted-foreground rtl:space-x-reverse"
          onClick={onClick}
        >
