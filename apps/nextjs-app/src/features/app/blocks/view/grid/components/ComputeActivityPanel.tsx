...
import { CircleAlert, Clock3, Info, Loader2 } from 'lucide-react';
...
const ActivityStatusMessage = ({
  ...
  return (
    <div className="space-y-2 text-xs text-muted-foreground">
      <p role="status" aria-describedby={description ? descriptionId : undefined}>
        {message}
      </p>
      {description ? (
        <>
      ...
      <Popover>
        <PopoverTrigger asChild>
          ...
          >
            ...
            ) : statusKey === 'computeActivity.statusSyncing' ? (
