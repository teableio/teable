          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent className="max-w-xs whitespace-normal">
                {t('table:table.integrity.v2.manualRepairPreviewTip')}
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
...
const RuleRepairAction = ({
  ...
  isRunning: boolean;
  isActive: boolean;
  onRepairRule?: (result: IntegrityResult) => void;
}) => {
  const { t } = useTranslation(['table']);
      ...
      <div className="inline-flex items-center">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start">
            <DropdownMenuItem onClick={() => onRepair(['warn'])}>
              {t('table:table.integrity.v2.repairWarnings')}
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => onRepair(['warn', 'error'])}>
