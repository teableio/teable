...
import type { TransactionService } from 'server/services/share-db/transaction.service';
import { transactionService } from 'server/services/share-db/transaction.service';
...
export const recordOpenApiService = new RecordOpenApiService(
  shareDbService,
  recordService,
  transactionService
);
