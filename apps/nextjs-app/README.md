...
> see detailed instructions (seeding, docker, supabase...) in the [@teable-group/db-main-prisma README](https://github.com/belgattitude/nextjs-monorepo-example/blob/main/packages/db-main-prisma/README.md).
