...
export const UPDATE_PREFERENCE_META = '/user/{userId}/';

export const userPreferenceMetaSchema = z.object({
...
export type IUserPreferenceMetaSchema = z.infer<typeof userPreferenceMetaSchema>;
