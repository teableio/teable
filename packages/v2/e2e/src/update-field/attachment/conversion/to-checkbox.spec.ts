/**
 * E2E tests for converting attachment field to checkbox.
 */
...
describe('update-field: attachment → checkbox conversion', () => {
  ...
  beforeAll(async () => {
    ...
    const table = await ctx.createTable({
      baseId: ctx.baseId,
      name: 'Attachment to Checkbox Conversion',
  ...
  test('should convert non-null attachment to true', async () => {
  ...
  test('should keep null as null', async () => {
