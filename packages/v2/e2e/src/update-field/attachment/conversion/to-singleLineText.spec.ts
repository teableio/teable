/**
 * E2E tests for converting attachment field to singleLineText.
 */
...
describe('update-field: attachment → singleLineText conversion', () => {
  ...
  beforeAll(async () => {
    ...
    const table = await ctx.createTable({
      baseId: ctx.baseId,
      name: 'Attachment to singleLineText Conversion',
