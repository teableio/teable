/**
 * E2E tests for converting attachment field to multipleSelect.
 */
...
describe('update-field: attachment → multipleSelect conversion', () => {
  ...
  beforeAll(async () => {
    ...
    const table = await ctx.createTable({
      baseId: ctx.baseId,
      name: 'Attachment to multipleSelect Conversion',
