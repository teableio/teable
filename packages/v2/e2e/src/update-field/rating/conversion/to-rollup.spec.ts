/**
 * E2E tests for converting rating field to rollup.
 *
...
describe('update-field: rating → rollup conversion', () => {
  ...
  test('should convert rating to rollup and clear data', async () => {
  ...
  test('should handle null values', async () => {
    const fieldId = await createRatingField('Null Rating Field');
    const hostRecord = await ctx.createRecord(hostTableId, {
