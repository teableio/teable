/**
 * E2E tests for converting Rating field to Checkbox.
 *
 * Conversion behavior (NumberFieldConversionVisitor):
 * - 0 → false (stored as null in checkbox)
 * - non-zero → true
 * - null → null
 */
...
describe('update-field: rating → checkbox conversion', () => {
  ...
  beforeAll(async () => {
    ...
    const table = await ctx.createTable({
      baseId: ctx.baseId,
      name: 'Rating to Checkbox Conversion',
