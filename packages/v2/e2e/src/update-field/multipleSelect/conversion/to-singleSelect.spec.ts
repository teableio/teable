...
describe('update-field: multipleSelect → singleSelect conversion', () => {
  ...
  test('should preserve all select option metadata when only one choice is used', async () => {
    ...
    const choices = [
      { id: 'choRed00000000002', name: 'Red', color: 'redBright' as const },
      { id: 'choGreen000000002', name: 'Green', color: 'greenBright' as const },
      { id: 'choUnused00000002', name: 'Unused', color: 'grayBright' as const },
    ];
