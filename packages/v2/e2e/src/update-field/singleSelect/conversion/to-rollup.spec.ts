/**
 * E2E tests for converting singleSelect field to rollup.
 *
...
describe('update-field: singleSelect → rollup conversion', () => {
  ...
  test('should convert singleSelect to rollup and clear data', async () => {
    const fieldId = await createSingleSelectField('SS Field');
  ...
  test('should handle null values', async () => {
    const fieldId = await createSingleSelectField('Null SS Field');
    const hostRecord = await ctx.createRecord(hostTableId, {
