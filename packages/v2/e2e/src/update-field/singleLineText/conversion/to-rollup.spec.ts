/**
 * E2E tests for converting singleLineText field to rollup.
 *
...
describe('update-field: singleLineText → rollup conversion', () => {
  ...
  test('should convert singleLineText to rollup and clear data', async () => {
