/**
 * E2E tests for converting number field to Attachment.
 *
 * Conversion behavior:
 * - All number values become null (incompatible types - alterColumnTypeToNull)
 * - null remains null
 */
...
describe('update-field: number → attachment conversion', () => {
  ...
  beforeAll(async () => {
    ...
    const table = await ctx.createTable({
      baseId: ctx.baseId,
      name: 'Number to Attachment Conversion',
