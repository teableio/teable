/**
 * E2E tests for converting number field to rollup.
 *
...
describe('update-field: number → rollup conversion', () => {
  ...
  test('should convert number to rollup and clear data', async () => {
