export const v2CoreTokens = {
  ...
  tableCommentQueryRepository: Symbol('v2.core.tableCommentQueryRepository'),
  tableRecordRepository: Symbol('v2.core.tableRecordRepository'),
  tableSchemaRepository: Symbol('v2.core.tableSchemaRepository'),
  formulaAdmissionService: Symbol.for('v2.core.formulaAdmissionService'),
  formulaSourceBudget: Symbol.for('v2.core.formulaSourceBudget'),
  ...
  fieldDeleteSnapshotSink: Symbol('v2.core.fieldDeleteSnapshotSink'),
  ...
  viewUndoRedoService: Symbol('v2.core.viewUndoRedoService'),
  viewManualSortService: Symbol('v2.core.viewManualSortService'),
  ...
  restoreFieldStreamApplicationService: Symbol('v2.core.restoreFieldStreamApplicationService'),
  recordBulkUpdateService: Symbol('v2.core.recordBulkUpdateService'),
  recordReorderService: Symbol('v2.core.recordReorderService'),
  buttonClickWorkflowService: Symbol('v2.core.buttonClickWorkflowService'),
  ...
  collaboratorDirectoryService: Symbol('v2.core.collaboratorDirectoryService'),
  ...
  baseDataBulkCopier: Symbol('v2.core.baseDataBulkCopier'),
  computedActivityReader: Symbol('v2.core.computedActivityReader'),
  computedOutboxAdmin: Symbol('v2.core.computedOutboxAdmin'),
  ...
  recordQueryPluginRunner: Symbol('v2.core.recordQueryPluginRunner'),
  recordQueryPlugins: Symbol('v2.core.recordQueryPlugins'),
  ...
  viewPluginCreationService: Symbol('v2.core.viewPluginCreationService'),
  viewPluginRepository: Symbol('v2.core.viewPluginRepository'),
  ...
  fieldTrashRepository: Symbol('v2.core.fieldTrashRepository'),
  ...
  domainWriteTransaction: Symbol('v2.core.domainWriteTransaction'),
  durableSubscriptionCatalog: Symbol('v2.core.durableSubscriptionCatalog'),
  projectionMessageJournal: Symbol('v2.core.projectionMessageJournal'),
  realtimeEngine: Symbol('v2.core.realtimeEngine'),
  logger: Symbol('v2.core.logger'),
  tracer: Symbol('v2.core.tracer'),
  tableQueryObservability: Symbol('v2.core.tableQueryObservability'),
  csvParser: Symbol('v2.core.csvParser'),
  dotTeaParser: Symbol('v2.core.dotTeaParser'),
  hasher: Symbol('v2.core.hasher'),
  tableDataSafetyLimits: Symbol('v2.core.tableDataSafetyLimits'),
  ...
  undoRedoReplayConfig: Symbol('v2.core.undoRedoReplayConfig'),
} as const;
