...
import type { IForeignTableLoaderService } from './ForeignTableLoaderService';
...
export const loadLinkTitleFillForeignTables = async (
  context: IExecutionContext,
  foreignTableLoaderService: IForeignTableLoaderService,
  specs: ReadonlyArray<ICellValueSpec | null>
  ...
  const foreignTablesResult = await foreignTableLoaderService.load(context, {
