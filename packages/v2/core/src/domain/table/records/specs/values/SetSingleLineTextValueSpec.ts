...
/**
 * Specification for setting a single line text field value.
 */
export class SetSingleLineTextValueSpec extends MutateOnlySpec<TableRecord, ICellValueSpecVisitor> {
  constructor(
  ...
  accept(visitor: ICellValueSpecVisitor): Result<void, DomainError> {
    return visitor.visitSetSingleLineTextValue(this);
  }
}
