...
/**
 * Specification for setting a multiple select field value.
 * The value should be an array of valid option IDs from the field's options.
 */
export class SetMultipleSelectValueSpec extends MutateOnlySpec<TableRecord, ICellValueSpecVisitor> {
  constructor(
  ...
  accept(visitor: ICellValueSpecVisitor): Result<void, DomainError> {
    return visitor.visitSetMultipleSelectValue(this);
  }
}
