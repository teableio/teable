...
/**
 * Specification for setting a number field value.
 */
export class SetNumberValueSpec extends MutateOnlySpec<TableRecord, ICellValueSpecVisitor> {
  constructor(
  ...
  accept(visitor: ICellValueSpecVisitor): Result<void, DomainError> {
    return visitor.visitSetNumberValue(this);
  }
}
