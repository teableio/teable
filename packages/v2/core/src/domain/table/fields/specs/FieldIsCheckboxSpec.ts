...
export class FieldIsCheckboxSpec implements ISpecification<Field, ISpecVisitor> {
  private constructor() {}

  static create(): FieldIsCheckboxSpec {
    return new FieldIsCheckboxSpec();
  }

  isSatisfiedBy(field: Field): boolean {
    return field.type().equals(FieldType.checkbox());
  }
