...
export class FieldIsDateTimeValueSpec implements ISpecification<Field, ISpecVisitor> {
  private constructor() {}

  static create(): FieldIsDateTimeValueSpec {
    return new FieldIsDateTimeValueSpec();
  }
