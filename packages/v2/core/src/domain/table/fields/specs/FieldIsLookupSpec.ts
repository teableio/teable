...
export class FieldIsLookupSpec implements ISpecification<Field, ISpecVisitor> {
  private constructor() {}

  static create(): FieldIsLookupSpec {
    return new FieldIsLookupSpec();
  }

  isSatisfiedBy(field: Field): boolean {
    return field.type().equals(FieldType.lookup());
  }
