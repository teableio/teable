...
export class FieldIsFormulaSpec implements ISpecification<Field, ISpecVisitor> {
  private constructor() {}

  static create(): FieldIsFormulaSpec {
    return new FieldIsFormulaSpec();
  }

  isSatisfiedBy(field: Field): boolean {
    return field.type().equals(FieldType.formula());
  }
