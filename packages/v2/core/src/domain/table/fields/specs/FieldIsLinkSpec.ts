...
export class FieldIsLinkSpec implements ISpecification<Field, ISpecVisitor> {
  private constructor() {}

  static create(): FieldIsLinkSpec {
    return new FieldIsLinkSpec();
  }

  isSatisfiedBy(field: Field): boolean {
    return field.type().equals(FieldType.link());
  }
