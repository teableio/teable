...
export class FieldIsRatingSpec implements ISpecification<Field, ISpecVisitor> {
  private constructor() {}

  static create(): FieldIsRatingSpec {
    return new FieldIsRatingSpec();
  }

  isSatisfiedBy(field: Field): boolean {
    return field.type().equals(FieldType.rating());
  }
