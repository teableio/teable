 ...
 * - Always multiple cell values (lookup can return multiple values from linked records)
...
export class LookupField extends Field implements ForeignTableRelatedField {
   ...
   * Lookup fields are always multiple (can have values from multiple linked records).
   */
