  ...
  async executeSync(
    ...
    return safeTry<void, DomainError>(
      async function* (this: ComputedFieldBackfillService) {
        ...
        const builder = new ComputedTableRecordQueryBuilder(db).from(input.table).select([fieldId]);
  ...
  async executeSyncMany(
    ...
    return safeTry<void, DomainError>(
      async function* (this: ComputedFieldBackfillService) {
        ...
        const builder = new ComputedTableRecordQueryBuilder(db).from(input.table).select(fieldIds);
