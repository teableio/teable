...
export const getFormulaPrompt = (prompt: string, fields: ReturnType<typeof useFields>) => {
  ...
  3. the field information of the current table is in the <fields> tag in the format of "fieldName", please refer to the field information to generate the formula.
