...
-- but the shared log table and trigger function are part of the database baseline.
-- Keep this file aligned with community/packages/v2/adapter-table-repository-postgres/src/shared/undoCaptureGlobalsSql.ts.
