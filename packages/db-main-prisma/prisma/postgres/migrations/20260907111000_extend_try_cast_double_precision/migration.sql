-- Extend the legacy input-validation polyfill for indexable numeric array membership.
--
...
BEGIN
  ...
  ) OR to_regprocedure('public.teable_try_cast_valid(text,text)') IS NOT NULL THEN
    ...
    BEGIN
      ...
      CASE target_type
        ...
        WHEN 'double precision' THEN
          PERFORM input_text::double precision;
