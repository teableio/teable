...
interface SendMailProps extends SVGProps<SVGSVGElement> {
  withBackground?: boolean;
}

const SendMail = ({ withBackground = true, ...props }: SendMailProps) => (
  <svg
    ...
    {...props}
  >
    {withBackground && <rect width={24} height={24} fill="#2684FF" fillOpacity={0.3} rx={3} />}
    <path
      fill="#2684FF"
      stroke="#2684FF"
      strokeLinecap="round"
    ...
    />
    <g filter={withBackground ? 'url(#prefix__send-mail)' : undefined} shapeRendering="crispEdges">
      <path
        fill="#2684FF"
        fillOpacity={0.6}
