...
const nextConfig = {
  basePath,
  output: 'standalone',
  // Transpile workspace packages for proper resolution
  transpilePackages: ['@teable/core', '@teable/sdk', '@teable/ui-lib', '@teable/openapi', '@teable/icons', '@teable/common-i18n'],
  turbopack: {
    root: workspaceRoot,
  },
